...
public class PartServise {
    ...
    public List<PartsEntity> part(ModelCarEntity model, GroupPartsEntity group, SparePartsEntity spare) { return partsEntityRepository.findByNumer(model, group, spare);    }
}
